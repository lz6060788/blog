      ...
      >
        ...
        {error && (
          <motion.div
            ...
            className="mb-6 p-4 bg-theme-error-bg border border-theme-error-primary/30 rounded-lg flex items-start gap-3"
          >
            <WarningCircle className="w-5 h-5 text-theme-error-primary flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <p className="text-sm font-medium text-theme-error-text">
                登录失败
              </p>
              <p className="text-sm text-theme-error-primary mt-1">
                未授权访问，只有管理员可以登录此博客。
              </p>
            </div>
          </motion.div>
