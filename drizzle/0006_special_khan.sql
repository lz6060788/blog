CREATE TABLE `ai_call_logs` (
	...
	`error_message` text,
	`duration_ms` integer,
	`created_at` text DEFAULT '2026-02-28T08:52:53.021Z' NOT NULL,
...
CREATE TABLE `ai_function_mappings` (
	...
	`model_config_id` text,
	`created_at` text DEFAULT '2026-02-28T08:52:53.020Z' NOT NULL,
	`updated_at` text DEFAULT '2026-02-28T08:52:53.020Z' NOT NULL,
	FOREIGN KEY (`model_config_id`) REFERENCES `ai_model_configs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
CREATE TABLE `__new_categories` (
	...
	`slug` text NOT NULL,
	`description` text,
	`createdAt` text DEFAULT '2026-02-28T08:52:53.019Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-02-28T08:52:53.019Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_posts` (
	...
	`createdAt` text DEFAULT '2026-02-28T08:52:53.020Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-02-28T08:52:53.020Z' NOT NULL,
...
CREATE TABLE `__new_settings` (
	...
	`updatedAt` text DEFAULT '2026-02-28T08:52:53.021Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`emailVerified` text,
	`image` text,
	`createdAt` text DEFAULT '2026-02-28T08:52:53.017Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-02-28T08:52:53.017Z' NOT NULL
);
--> statement-breakpoint
