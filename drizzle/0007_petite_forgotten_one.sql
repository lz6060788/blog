CREATE TABLE `file_uploads` (
	...
	`created_at` text DEFAULT '2026-03-02T17:32:04.517Z' NOT NULL,
...
CREATE TABLE `__new_ai_function_mappings` (
	...
	`model_config_id` text,
	`created_at` text DEFAULT '2026-03-02T17:32:04.517Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-02T17:32:04.517Z' NOT NULL,
	FOREIGN KEY (`model_config_id`) REFERENCES `ai_model_configs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
CREATE TABLE `__new_categories` (
	...
	`slug` text NOT NULL,
	`description` text,
	`createdAt` text DEFAULT '2026-03-02T17:32:04.516Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-02T17:32:04.516Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_posts` (
	...
	`createdAt` text DEFAULT '2026-03-02T17:32:04.517Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-02T17:32:04.517Z' NOT NULL,
	FOREIGN KEY (`authorId`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`categoryId`) REFERENCES `categories`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
INSERT INTO `__new_posts`("id", "title", "content", "excerpt", "published", "authorId", "categoryId", "read_time", "published_date", "ai_summary", "ai_summary_generated_at", "ai_summary_status", "createdAt", "updatedAt") SELECT "id", "title", "content", "excerpt", "published", "authorId", "categoryId", "read_time", "published_date", "ai_summary", "ai_summary_generated_at", "ai_summary_status", "createdAt", "updatedAt" FROM `posts`;--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`emailVerified` text,
	`image` text,
	`createdAt` text DEFAULT '2026-03-02T17:32:04.515Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-02T17:32:04.516Z' NOT NULL
);
--> statement-breakpoint
