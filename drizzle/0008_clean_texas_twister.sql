...
CREATE TABLE `__new_ai_call_logs` (
	...
	`error_message` text,
	`duration_ms` integer,
	`created_at` text DEFAULT '2026-03-03T07:26:33.150Z' NOT NULL,
...
INSERT INTO `__new_ai_call_logs`("id", "post_id", "model_config_id", "action", "provider", "model", "input_tokens", "output_tokens", "status", "error_message", "duration_ms", "created_at") SELECT "id", "post_id", "model_config_id", "action", "provider", "model", "input_tokens", "output_tokens", "status", "error_message", "duration_ms", "created_at" FROM `ai_call_logs`;--> statement-breakpoint
...
CREATE TABLE `__new_ai_function_mappings` (
	...
	`model_config_id` text,
	`created_at` text DEFAULT '2026-03-03T07:26:33.150Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-03T07:26:33.150Z' NOT NULL,
	FOREIGN KEY (`model_config_id`) REFERENCES `ai_model_configs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_ai_model_configs`("id", "name", "provider", "model", "api_key_encrypted", "base_url", "max_tokens", "temperature", "enabled", "created_at", "updated_at") SELECT "id", "name", "provider", "model", "api_key_encrypted", "base_url", "max_tokens", "temperature", "enabled", "created_at", "updated_at" FROM `ai_model_configs`;--> statement-breakpoint
...
CREATE TABLE `__new_categories` (
	...
	`slug` text NOT NULL,
	`description` text,
	`createdAt` text DEFAULT '2026-03-03T07:26:33.149Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-03T07:26:33.149Z' NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_posts`("id", "title", "content", "excerpt", "published", "authorId", "categoryId", "read_time", "published_date", "ai_summary", "ai_summary_generated_at", "ai_summary_status", "cover_image_url", "ai_cover_status", "ai_cover_generated_at", "ai_cover_prompt", "createdAt", "updatedAt") SELECT "id", "title", "content", "excerpt", "published", "authorId", "categoryId", "read_time", "published_date", "ai_summary", "ai_summary_generated_at", "ai_summary_status", "cover_image_url", "ai_cover_status", "ai_cover_generated_at", "ai_cover_prompt", "createdAt", "updatedAt" FROM `posts`;--> statement-breakpoint
...
CREATE TABLE `__new_settings` (
	...
	`updatedAt` text DEFAULT '2026-03-03T07:26:33.150Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`emailVerified` text,
	`image` text,
	`createdAt` text DEFAULT '2026-03-03T07:26:33.148Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-03T07:26:33.148Z' NOT NULL
);
--> statement-breakpoint
