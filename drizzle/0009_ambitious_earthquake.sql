...
CREATE TABLE `__new_ai_call_logs` (
	...
	`image_format` text,
	`image_cost` integer,
	`created_at` text DEFAULT '2026-03-03T07:29:24.370Z' NOT NULL,
...
CREATE TABLE `__new_ai_function_mappings` (
	...
	`model_config_id` text,
	`created_at` text DEFAULT '2026-03-03T07:29:24.370Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-03T07:29:24.370Z' NOT NULL,
	FOREIGN KEY (`model_config_id`) REFERENCES `ai_model_configs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
CREATE TABLE `__new_categories` (
	...
	`slug` text NOT NULL,
	`description` text,
	`createdAt` text DEFAULT '2026-03-03T07:29:24.370Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-03T07:29:24.370Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`emailVerified` text,
	`image` text,
	`createdAt` text DEFAULT '2026-03-03T07:29:24.368Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-03T07:29:24.369Z' NOT NULL
);
--> statement-breakpoint
