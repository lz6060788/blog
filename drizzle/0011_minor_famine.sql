...
INSERT INTO `__new_playlist_songs`("id", "playlist_id", "song_id", "position") SELECT "id", "playlist_id", "song_id", "position" FROM `playlist_songs`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `unique_playlist_song` ON `playlist_songs` (`playlist_id`,`song_id`);--> statement-breakpoint
CREATE TABLE `__new_ai_call_logs` (
	...
	`image_format` text,
	`image_cost` integer,
	`created_at` text DEFAULT '2026-03-10T19:00:08.472Z' NOT NULL,
...
CREATE TABLE `__new_ai_function_mappings` (
	...
	`model_config_id` text,
	`created_at` text DEFAULT '2026-03-10T19:00:08.471Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-10T19:00:08.471Z' NOT NULL,
	FOREIGN KEY (`model_config_id`) REFERENCES `ai_model_configs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
...
CREATE TABLE `__new_categories` (
	...
	`slug` text NOT NULL,
	`description` text,
	`createdAt` text DEFAULT '2026-03-10T19:00:08.471Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-10T19:00:08.471Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_playlists` (
	...
	`created_at` text DEFAULT '2026-03-10T19:00:08.472Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-10T19:00:08.472Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_settings` (
	...
	`updatedAt` text DEFAULT '2026-03-10T19:00:08.472Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`emailVerified` text,
	`image` text,
	`createdAt` text DEFAULT '2026-03-10T19:00:08.469Z' NOT NULL,
	`updatedAt` text DEFAULT '2026-03-10T19:00:08.470Z' NOT NULL
);
--> statement-breakpoint
