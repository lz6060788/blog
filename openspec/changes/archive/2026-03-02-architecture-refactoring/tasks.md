...
- [x] 9.1 在文章列表 API 中添加分页参数支持
- [x] 9.2 在文章列表 API 中实现分页响应格式
- [x] 9.3 实现向后兼容逻辑（未提供分页参数时返回所有数据）
- [x] 9.4 添加分页参数验证
- [ ] 9.5 在分类筛选 API 中集成分页
- [ ] 9.6 在标签筛选 API 中集成分页
- [x] 9.7 更新 API 文档或代码注释

## 10. 样式系统清理

- [x] 10.1 检查 `app/styles/legacy/` 目录中的样式文件使用情况
- [x] 10.2 将 legacy 样式迁移到 Tailwind 或新的语义化变量
- [x] 10.3 删除 `app/styles/legacy/` 目录
- [ ] 10.4 验证所有页面样式正常显示
...
- [x] 13.1 更新 README 或架构文档，反映新的分层架构
- [x] 13.2 添加 Service 层开发规范文档
- [x] 13.3 添加 Repository 层开发规范文档
- [x] 13.4 更新组件目录结构说明
- [x] 13.5 添加分页 API 使用示例
